...
flightsjoinedandfilteredbytimeandyear = FILTER flightsjoinedandfilteredbytimeandyear  BY ((filered_leg2flights::Year == 2007 AND
 filered_leg2flights::Month >= 06) OR (filered_leg2flights::Year == 2008 AND filered_leg2flights::Month <= 05)  );
